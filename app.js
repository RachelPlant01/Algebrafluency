...
function buildSquaresSettings() {
  ...
  const types = [
    { key: 'mix', title: 'Mix of both', desc: 'e.g. 4² = 16 and √81 = 9, up to 15² / √225' },
    { key: 'square', title: 'Squares only', desc: 'e.g. 4² = 16, up to 15² = 225' },
    { key: 'root', title: 'Square roots only', desc: 'e.g. √81 = 9, up to √225 = 15' }
  ];
  types.forEach((t, i) => {
    const chip = document.createElement('button');
...
function genSquaresQuestion() {
  ...
  // Square: n² — every option is a genuine square number (m² for m 1-15).
